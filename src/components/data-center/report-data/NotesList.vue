...
const notes = ref([
  {
    ...
    content: 'Vue 3的组合式API为我们提供了更灵活的逻辑复用方式。通过setup函数，我们可以更好地组织组件逻辑，使代码更加清晰和可维护。响应式系统也得到了显著改进，使用Proxy替代了Object.defineProperty，性能更优。',
    preview: 'Vue 3的组合式API为我们提供了更灵活的逻辑复用方式。通过setup函数，我们可以更好地组织组件逻辑...',
    tags: ['学习笔记', '技术文档'],
  ...
  },
  {
    id: 2,
    title: '项目开发经验总结',
    content: '在最近的项目开发中，我学到了很多宝贵的经验。首先是代码规范的重要性，统一的代码风格能够大大提高团队协作效率。其次是测试的重要性，完善的测试用例能够有效减少bug的产生。最后是文档的重要性，好的文档能够帮助团队成员快速理解项目结构。',
    preview: '在最近的项目开发中，我学到了很多宝贵的经验。首先是代码规范的重要性，统一的代码风格能够大大提高团队协作效率...',
    tags: ['项目总结', '心得体会'],
  ...
  },
  {
    id: 3,
    title: '团队会议记录 - 产品迭代讨论',
    content: '会议时间：2024年1月13日 下午2:00-4:00\n参会人员：产品经理、技术负责人、UI设计师、前端开发\n\n会议议题：\n1. 下个版本功能规划\n2. 技术架构优化方案\n3. 用户体验改进建议\n\n讨论结果：\n- 确定新增用户反馈功能\n- 优化页面加载性能\n- 改进移动端适配',
    preview: '会议时间：2024年1月13日 下午2:00-4:00\n参会人员：产品经理、技术负责人、UI设计师、前端开发...',
    tags: ['会议记录', '工作计划'],
    createTime: '2024-01-13 16:30:00',
    updateTime: '2024-01-13 18:00:00',
    wordCount: 234
  },
  {
    id: 4,
    title: '《JavaScript高级程序设计》读书笔记',
    content: '这本书深入讲解了JavaScript的核心概念和高级特性。特别是关于闭包、原型链、异步编程等概念的解释非常清晰。通过实际案例和代码示例，让我对JavaScript有了更深入的理解。推荐给所有想要深入学习JavaScript的开发者。',
    preview: '这本书深入讲解了JavaScript的核心概念和高级特性。特别是关于闭包、原型链、异步编程等概念的解释非常清晰...',
    tags: ['读书笔记', '学习笔记'],
    createTime: '2024-01-12 20:00:00',
    updateTime: '2024-01-12 22:30:00',
    wordCount: 178
  },
  {
    id: 5,
    title: '前端性能优化实践',
    content: '在前端性能优化方面，我总结了几个关键点：\n1. 图片优化：使用WebP格式，实现懒加载\n2. 代码分割：按需加载，减少初始包大小\n3. 缓存策略：合理使用浏览器缓存和CDN\n4. 渲染优化：避免重排重绘，使用虚拟滚动\n5. 网络优化：启用Gzip压缩，使用HTTP/2',
    preview: '在前端性能优化方面，我总结了几个关键点：\n1. 图片优化：使用WebP格式，实现懒加载\n2. 代码分割：按需加载，减少初始包大小...',
    tags: ['技术文档', '心得体会'],
  ...
  },
  {
    id: 6,
    title: '2024年个人学习计划',
    content: '新的一年，我制定了详细的学习计划：\n\n技术方面：\n- 深入学习Vue 3和React 18\n- 掌握TypeScript高级特性\n- 学习Node.js后端开发\n- 了解微前端架构\n\n软技能：\n- 提升英语水平\n- 学习项目管理\n- 加强沟通协作能力\n\n目标：\n- 完成3个开源项目\n- 发表5篇技术文章\n- 参加2次技术大会',
    preview: '新的一年，我制定了详细的学习计划：\n\n技术方面：\n- 深入学习Vue 3和React 18\n- 掌握TypeScript高级特性...',
    tags: ['工作计划', '学习笔记'],
    createTime: '2024-01-10 10:00:00',
    updateTime: '2024-01-10 12:15:00',
    wordCount: 312
  }
])
